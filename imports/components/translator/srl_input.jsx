  ...
  class extends React.Component {
    ...
    render() {
      ...
      const helpTextContent = [
        ...
        ["\\t", "tab"],
        ["\\v", "vertical tab"],
        ["\\\\ Double backslash escapes itself. Use a single backslash for characters that usually have special handling. You can escape that character and it will be treated literally. For example \\d will match a digit, while \\\\d will match a string that has a backslash followed by the letter d.", "backslash"],
        [null, null],
        ["Flags", null],
        ["/regex/m", "multi line"],
