  ...
  class extends React.Component {
    ...
    render() {
      ...
      const helpTextContent = [
        ...
        ["\\t", "tab"],
        ["\\n", "new line"],
        ["\\ Use a backslash for characters that usually have special handling. You can escape that character and it will be treated literally. For example \d will match a digit, while \\d will match a string that has a backslash followed by the letter d.", null],
        [null, null],
        ["Flags", null],
        ["/regex/m", "multi line"],
    ...
    return (
        <div className="translator-input-section">
          ...
          <header>
            <h2>Syntax: Simple Regex Language vs Regex</h2>
          </header>
